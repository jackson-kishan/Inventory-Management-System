                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <section type="text" class="form-control form-select" id="productCategoryUpdate">
...
async function UpdateFillCreateDropDown() {
    ...
    async function FillUpUpdateForm(id, filePath) {
       ...
       document.getElementById('oldImg').src= oldImg;

       showLoader();

        await UpdateFillCreateDropDown();
